...
tabs = st.tabs(["𝐇𝐨𝐦𝐞", "𝐒𝐭𝐚𝐭𝐬", "𝐌𝐨𝐧𝐭𝐡𝐥𝐲 𝐓𝐢𝐦𝐞𝐥𝐢𝐧𝐞", "𝐃𝐚𝐢𝐥𝐲 𝐓𝐢𝐦𝐞𝐥𝐢𝐧𝐞", "𝐀𝐜𝐭𝐢𝐯𝐢𝐭𝐲", "𝐖𝐨𝐫𝐝𝐂𝐥𝐨𝐮𝐝", "𝐌𝐨𝐬𝐭 𝐂𝐨𝐦𝐦𝐨𝐧 𝐖𝐨𝐫𝐝𝐬", "𝐄𝐦𝐨𝐣𝐢 𝐀𝐧𝐚𝐥𝐲𝐬𝐢𝐬", "𝐒𝐞𝐧𝐭𝐢𝐦𝐞𝐧𝐭 𝐀𝐧𝐚𝐥𝐲𝐬𝐢𝐬", "𝐀𝐰𝐚𝐫𝐝𝐬", "𝐎𝐯𝐞𝐫𝐚𝐥𝐥 𝐃𝐚𝐭𝐚" ,"𝐀𝐛𝐨𝐮𝐭 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫"])
...
with tabs[0]:
    ...
    if '𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀_𝘀𝗵𝗼𝘄𝗻' not in st.session_state:
        ...
        st.write("5. 𝒀𝒐𝒖  𝒄𝒂𝒏  𝒂𝒍𝒔𝒐  𝒌𝒏𝒐𝒘  𝒂𝒃𝒐𝒖𝒕  𝒎𝒆  𝒊𝒏  𝒕𝒉𝒆  '𝑨𝒃𝒐𝒖𝒕 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫'  𝒕𝒂𝒃.")
